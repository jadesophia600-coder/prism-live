            ...
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 relative z-10">
              <div className="space-y-2 max-w-2xl">
                ...
                <p className="text-xs sm:text-sm text-slate-300 leading-relaxed font-medium">
                  {category?.description || 'Discover live channels and top broadcasters.'}
                </p>
                <div className="flex items-center gap-6 text-xs text-slate-400 font-mono pt-2">
                  <span className="flex items-center gap-1.5 text-cyan-400 font-bold">
                    <Radio className="w-4 h-4 text-rose-500 animate-pulse" /> {category?.channels || 0} Live Channels
                  </span>
                  <span className="flex items-center gap-1.5 text-indigo-300 font-bold">
                    <Eye className="w-4 h-4 text-indigo-400" /> {category?.viewers ? (category.viewers / 1000).toFixed(1) : 0}k Live Viewers
                  </span>
                </div>
              </div>
